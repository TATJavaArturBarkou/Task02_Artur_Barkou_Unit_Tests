...
public class RegularExpressionTest {
	...
	public void trueTest(String inputString) {
		...
		Assert.assertTrue(Util.checkInputNumbers(inputString, com.epam.training.tsylko.andrei.excercise9.Test.CHECKER));
	}
	
	@Test(dataProvider = "falseDp")
	public void falseTest(String inputString) {
		
		Assert.assertFalse(Util.checkInputNumbers(inputString, com.epam.training.tsylko.andrei.excercise9.Test.CHECKER));
	}
}
